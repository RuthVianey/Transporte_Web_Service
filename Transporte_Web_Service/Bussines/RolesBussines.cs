...
namespace Transporte_Web_Service.Bussines
{
    public class RolesBussines
    {
        ...
        public async Task<ApiResponse<IEnumerable<Entity_RespuestaGeneral?>>> Bs_Rol_Desactivar(int IdRol, int IdEmpresa)
        {
            if (IdEmpresa <= 0)
            {
        ...
        public async Task<ApiResponse<IEnumerable<Entity_RespuestaGeneral?>>> Bs_Rol_Guardar(int IdRol, int IdEmpresa, string Nombre, byte Activo)
        {
            if (IdEmpresa <= 0)
            {
                return ApiResponse<IEnumerable<Entity_RespuestaGeneral?>>.Fail("La empresa es obligatoria.");
        ...
        public async Task<ApiResponse<IEnumerable<Entity_Listar_Roles?>>> Bs_Rol_Listar(int IdEmpresa, byte SoloActivos)
        {
            if (IdEmpresa <= 0)
            {
                return ApiResponse<IEnumerable<Entity_Listar_Roles?>>.Fail("La empresa es obligatoria.");
            }
            ...
            if (resumen == null)
            {
                return ApiResponse<IEnumerable<Entity_Listar_Roles?>>.Fail("No se encontró información.");
            }
            return ApiResponse<IEnumerable<Entity_Listar_Roles?>>.Success(resumen);
        }

        public async Task<ApiResponse<IEnumerable<Entity_Listar_Roles?>>> Bs_Rol_ObtenerPorId(int IdEmpresa, int IdRol)
        {
            if (IdEmpresa <= 0)
            {
                return ApiResponse<IEnumerable<Entity_Listar_Roles?>>.Fail("La empresa es obligatoria.");
        ...
        public async Task<ApiResponse<IEnumerable<Entity_RespuestaGeneral?>>> Bs_RolPrograma_GuardarPermiso(int IdRol, int IdEmpresa, int IdPrograma, byte PuedeLeer, byte PuedeEscribir, byte PuedeEliminar)
        {
            if (IdEmpresa <= 0)
            {
                return ApiResponse<IEnumerable<Entity_RespuestaGeneral?>>.Fail("La empresa es obligatoria.");
        ...
        public async Task<ApiResponse<IEnumerable<Entity_RolPrograma_ListarPorRol?>>> Bs_RolPrograma_ListarPorRol(int IdEmpresa, int IdRol)
        {
            if (IdEmpresa <= 0)
            {
                return ApiResponse<IEnumerable<Entity_RolPrograma_ListarPorRol?>>.Fail("La empresa es obligatoria.");
            }
